...
| **artwork_category_id** | Category or type of artwork                         |
| **title**               | Title of the artwork                                |
| **year**                | Year the artwork was created                        |
| **artwork_medium_id**   | Medium or material classification                   |
| **paper_type_id**       | Paper or support material reference (if applicable) |
